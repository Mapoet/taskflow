...
| WP4.5 OTel/SLO | `[~]` | 80–86% | correlation/privacy、W3C trace、deterministic sampling、span/metric/log、OTLP HTTP(S)、CA/hostname/client-cert、SQLite 三信号 spool/restart、audit bridge、threshold SLO 与窗口化 error-budget/burn-rate fail-closed、loopback collector | scheduled backoff/jitter/lease/dead-letter/retention、真实 Collector mTLS 证据、dashboard/alert backend、provider usage 对账 |
