...
| `P4-V2-RC-R2X-20260811` | `P4-V2-R2X.1–R2X.6 / phase4-v2-residual-r1` | executing | 2026-08-11 | Codex / user explicit continuous approval | ArtifactExecutor、manifest/digest、deterministic oracle、实际 remediation/reexecution/selective reverification | implementation/test pending | 必须证明新 artifact 与二次 Assurance，不以 callback digest 冒充真实执行 |
