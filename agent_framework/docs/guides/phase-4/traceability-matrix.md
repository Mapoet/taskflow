...
| `R4V2-04` 多角色专业验收 | `P4-V2-F4V.1–F4V.10` | partial | `assurance/{professional_workflow,assurance_graph_template,evidence,arbiter}`；`RoleRuntimeAssuranceModel`；`ManifestEvidenceOracle`；InMemory/SQLite `AssuranceStore` | `phase4_assurance_workflow_{contracts,negative,integration}`、`phase4_assurance_workflow`：strict/CAS、Verification Planner、五专业角色+Resolver、能力交集/独立性、evidence closure、oracle precedence、缺产物、自证降权、冲突、RoleRuntime、restart、GraphExecutor；报告 `acceptance-P4-V2-F4V-20260810.md` | 离线核心 implemented；真实 repo/build/runtime/domain/security/Sandbox oracle adapters、双 verifier 策略、生产 calibration/benchmark、跨 Store atomic、F5R remediation/replan、默认强制、Live/UI pending，故不升级为 verified |
