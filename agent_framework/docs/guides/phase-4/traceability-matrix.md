...
| R4.9 迁移与垂直认证 | 4.9.20 | partial | v2 isolated path；Memory→Plan→Run→Acceptance→Remediation 纵向绑定 | `phase4_vertical` + Phase 3/4 offline regression | 46 tests PASS；restart terminal binding | dual-read/real executor/live E2E pending |
