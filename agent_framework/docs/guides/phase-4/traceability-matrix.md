...
| `R4V2-RC-06` Production Live | `R6L` | blocked | 未过期、签名、无 blocker 的 `executed=true` 报告 | production workflow/report gate 已强制独立 cell evidence verifier；当前仍没有批准的外部环境/凭据/runner，故不可签发认证 |
