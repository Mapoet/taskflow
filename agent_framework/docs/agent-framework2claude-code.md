...
| AF-CC-LTW 长时复杂工具工作流 | `[~]` | LTW0–LTW3 已完成；LTW4 已形成 production-gated typed adapters；LTW5 已形成 Invocation/Effect/Object/Run/CrossStore commit coordinator；LTW6 已闭环 durable workflow、事件/timeout wake、RoleRuntime cognition、plan CAS、typed descriptor repository、production executor registry/adapter、ready-node dispatcher、Invocation→node reconciliation、RunStore timer worker 和 production dependency gate；1000 heartbeat 零 LLM、去重 dispatch、重启 cursor、DAG 解锁、timer claim/complete 已测试 | LTW4/5 残余仍在；LTW7–LTW9 尚缺，现状仍不能声称已具备生产级长时自主工作能力 |
