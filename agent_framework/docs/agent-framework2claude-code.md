...
| AF-CC-LTW 长时复杂工具工作流 | `[~]` | LTW0–LTW3 已完成；LTW4 已形成 production-gated typed adapters；LTW5 已形成 Invocation/Effect/Object/Run/CrossStore commit coordinator；LTW6 已闭环 durable wait-observe-replan；LTW7 已闭环 incremental result/ObjectStore 生命周期；LTW8 已闭环 durable deadline/backpressure/cancellation generation、fencing claim、cooperative→terminate→kill→reconcile 状态机、provider control 下传和 unknown-effect ManualReview | LTW4/5 的真实 provider 残余与 LTW9 Recovery/Soak Certification 尚缺，现状仍不能声称已具备生产级长时自主工作能力 |
