...
// Boundary adapters are deliberately supplied by the deployment: they bind
// identity/policy, an approved artifact executor and the operations publisher.
// The builder owns the invariant that no callback/test port can enter production.
